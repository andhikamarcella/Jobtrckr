  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 pb-14">
      <header className="flex flex-col gap-4 pt-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-slate-600 dark:text-slate-300">Selamat datang kembali,</p>
          <h1 className="text-3xl font-semibold text-slate-900 transition-colors dark:text-slate-50">{ownerName}</h1>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="rounded-2xl border border-slate-300 px-4 py-2 text-sm text-slate-700 transition hover:bg-slate-200 dark:border-white/15 dark:text-slate-200 dark:hover:bg-white/10"
          >
            Logout
          </button>
        </div>
