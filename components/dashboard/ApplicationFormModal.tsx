...
export function ApplicationFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/55 px-4 py-8 backdrop-blur-xl">
      <div className="w-full max-w-2xl overflow-hidden rounded-4xl border border-white/70 bg-white/95 shadow-[0_24px_70px_rgba(148,163,184,0.32)] animate-modal-pop">
        <header className="flex flex-col gap-3 border-b border-white/70 px-6 py-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2">
            <p className="text-[11px] font-semibold uppercase tracking-[0.35em] text-slate-400">Form Lamaran</p>
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-200"
          >
            Tutup
          </button>
        </header>

        <form onSubmit={handleSubmit} className="flex max-h-[70vh] flex-col overflow-hidden">
          <div className="grid gap-6 overflow-y-auto px-6 pt-6 pb-4 md:grid-cols-2 md:pr-4">
            <Field label="Perusahaan" helper="Isi nama perusahaan yang kamu lamar." htmlFor="company">
              ...
              className="w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
              required
            />
          </Field>
          ...
          <Field label="Tanggal Lamar" helper="Pilih tanggal saat lamaran dikirim." htmlFor="applied_at">
            <input
              ...
              className="w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
              required
            />
          </Field>
          ...
          <Field label="Status" helper="Pilih tahapan terbaru dalam proses rekrutmen." htmlFor="status">
            <select
              ...
              className="w-full appearance-none rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
            >
          ...
          <Field label="Sumber" helper="Dari mana kamu menemukan lowongan ini." htmlFor="source">
            <select
              ...
              className="w-full appearance-none rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-400"
            >
          ...
          >
            <textarea
              ...
              className="min-h-[120px] w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
            />
          </Field>
          ...
          <div className="flex flex-col gap-3 border-t border-white/70 px-6 py-4 sm:flex-row sm:justify-end">
            <button
              type="button"
              onClick={onClose}
              className="rounded-3xl border border-slate-300 bg-white px-5 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-200"
            >
              Batal
            </button>
            <button
