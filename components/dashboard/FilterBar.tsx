      ...
      <button
        ...
        className={`whitespace-nowrap rounded-full border px-4 py-2 text-sm font-medium capitalize transition ${
          value === "all"
            ...
            : "border-slate-300 bg-white/90 text-slate-700 hover:bg-slate-100 dark:border-white/10 dark:bg-slate-900/40 dark:text-slate-200 dark:hover:bg-slate-900/60"
        }`}
      >
        All
      </button>
